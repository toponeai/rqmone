...
function buildLabelKeys() {
  return {
    ...
    "nav.ai": "" as const,
    "nav.messages": "" as const,
    "nav.notifications": "" as const,
    "nav.wallet": "" as const,
    "nav.live": "" as const,
...
const ITEMS: DockItem[] = [
  ...
  { id: "messages", label: "nav.messages", icon: MessagesIcon, to: "/messages" },
  { id: "notifications", label: "nav.notifications", icon: BellIcon, to: "/notifications" },
